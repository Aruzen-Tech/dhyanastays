...
const host_listing_controller_1 = require("./host-listing.controller");
const listing_service_1 = require("./listing.service");
const public_listing_controller_1 = require("./public-listing.controller");
...
exports.ListingModule = ListingModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            host_listing_controller_1.HostListingController,
