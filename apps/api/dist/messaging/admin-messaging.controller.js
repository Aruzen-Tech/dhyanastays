...
let AdminMessagingController = class AdminMessagingController {
    ...
    create(user, dto) {
        return this.messagingService.startConversation(user.sub, client_1.UserRole.ADMIN, dto);
    }
    unreadCount(user) {
    ...
    send(user, id, dto) {
        return this.messagingService.sendMessage(id, user.sub, client_1.UserRole.ADMIN, dto);
    }
    markRead(user, id) {
...
], AdminMessagingController.prototype, "list", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    ...
    __metadata("design:returntype", void 0)
], AdminMessagingController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AdminMessagingController.prototype, "unreadCount", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    ...
    __metadata("design:returntype", void 0)
], AdminMessagingController.prototype, "getOne", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdminMessagingController.prototype, "send", null);
__decorate([
...
exports.AdminMessagingController = AdminMessagingController = __decorate([
    (0, common_1.Controller)('admin/conversations'),
