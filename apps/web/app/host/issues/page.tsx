...
import { formatDate, hostIssuesApi } from '../../../lib/api';
...
export default function HostIssuesPage() {
  ...
  const handleUpdate = async () => {
    ...
    setUpdating(true);
    try {
      const updated = await hostIssuesApi.updateStatus(editingIssue.id, {
        status: newStatus,
  ...
  return (
    <div className="container-page py-10 max-w-4xl mx-auto">
      <h1 className="page-title mb-6">Guest Issues</h1>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="Add notes for the guest..."
                rows={3}
